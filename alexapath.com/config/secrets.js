...
if(process.env.NODE_ENV === 'test-travis') {
  module.exports.postgres = 'PUT_LOCALHOST_DATABASE_PATH_HERE';
  // testing server
} else if(process.env.NODE_ENV === 'amazon-test') {
  module.exports.postgres = 'PUT_DATABASE_PATH_HERE';
} else {
// production server
  module.exports.postgres =
      process.env.DATABASE_URL || 'PUT_DATABASE_PATH_HERE';
}
